...
import { loadTools, saveTool, removeTool, type Tool } from "@/lib/supabase-client";
import {
  loadCustomMaterials,
  saveCustomMaterial,
...
// ─── TOOLS (Section G) ─────────────────────────────────────────────────────────
// Same pattern as Section F · Vehicles: reads/writes go through the
// get-tools / save-tool / remove-tool edge functions (tools has RLS with no
// client-auth session in this app yet, so direct table access from the browser
// is blocked — same reason as vehicles above).
...
// ─── CUSTOM MATERIALS (Section H) ──────────────────────────────────────────────
// Same pattern as Section F · Vehicles: reads/writes go through the
// get-custom-materials / save-custom-material / remove-custom-material edge
// functions (custom_materials has RLS with no client-auth session in this app
// yet, so direct table access from the browser is blocked — same reason as
// vehicles above).
